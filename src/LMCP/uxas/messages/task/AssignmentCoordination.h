...
namespace task {
   ...
   protected:
      ...
      /** The state of the entity that will used for planning/assignment of the given automation request. A valid AssignmentCoordination must define PlanningState (null not allowed). */
