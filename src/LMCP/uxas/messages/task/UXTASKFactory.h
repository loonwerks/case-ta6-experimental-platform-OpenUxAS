...
#ifndef _UXTASK_FACTORY_H_
#define _UXTASK_FACTORY_H_
...
namespace task {
   ...
   protected:
      ...
      // Copy Constructor
      UXTASKFactory(const UXTASKFactory & that);

      // Assignment Operator
      UXTASKFactory & operator=(const UXTASKFactory & that);
   };
