...
#ifndef _UXNATIVE_FACTORY_H_
#define _UXNATIVE_FACTORY_H_
...
namespace uxnative {
   ...
   protected:
      // Constructor
      UXNATIVEFactory(void);

      // Copy Constructor
      UXNATIVEFactory(const UXNATIVEFactory & that);

      // Assignment Operator
      UXNATIVEFactory & operator=(const UXNATIVEFactory & that);
   };
