...
buf.extend(LMCPFactory.packMessage(obj, True))
#Pack ZeroizeCommand
obj = ZeroizeCommand.ZeroizeCommand()
buf.extend(LMCPFactory.packMessage(obj, True))
#Pack ZeroizeCondition
obj = ZeroizeCondition.ZeroizeCondition()
buf.extend(LMCPFactory.packMessage(obj, True))
#Pack DownloadRequest
obj = DownloadRequest.DownloadRequest()
buf.extend(LMCPFactory.packMessage(obj, True))
#Pack DownloadReply
obj = DownloadReply.DownloadReply()
buf.extend(LMCPFactory.packMessage(obj, True))
#Pack FileTransferRequest
obj = FileTransferRequest.FileTransferRequest()
buf.extend(LMCPFactory.packMessage(obj, True))
#Pack File
obj = File.File()
buf.extend(LMCPFactory.packMessage(obj, True))
#Pack FileTransfer
obj = FileTransfer.FileTransfer()
buf.extend(LMCPFactory.packMessage(obj, True))
