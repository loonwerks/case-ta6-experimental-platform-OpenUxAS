...
#ifndef _IMPACT_FACTORY_H_
#define _IMPACT_FACTORY_H_
...
namespace impact {
   ...
   protected:
      ...
      // Copy Constructor
      IMPACTFactory(const IMPACTFactory & that);

      // Assignment Operator
      IMPACTFactory & operator=(const IMPACTFactory & that);
   };
