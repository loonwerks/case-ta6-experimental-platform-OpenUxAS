...
namespace vehicles {
   ...
   const std::string GroundVehicleState::Subscription = "afrl.vehicles.GroundVehicleState";
   const std::string GroundVehicleState::TypeName = "GroundVehicleState";
   const std::string GroundVehicleState::SeriesName = "VEHICLES";
   const int64_t GroundVehicleState::SeriesId = 6216454340153722195LL;
   const uint16_t GroundVehicleState::SeriesVersion = 1;
   const uint32_t GroundVehicleState::TypeId = 2;
