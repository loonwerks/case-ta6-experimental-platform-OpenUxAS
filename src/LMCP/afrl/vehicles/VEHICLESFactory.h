...
#ifndef _VEHICLES_FACTORY_H_
#define _VEHICLES_FACTORY_H_
...
namespace vehicles {
   ...
   protected:
      // Constructor
      VEHICLESFactory(void);

      // Copy Constructor
      VEHICLESFactory(const VEHICLESFactory & that);

      // Assignment Operator
      VEHICLESFactory & operator=(const VEHICLESFactory & that);
   };
