...
#ifndef _CMASI_FACTORY_H_
#define _CMASI_FACTORY_H_
...
namespace cmasi {
   ...
   protected:
      ...
      // Copy Constructor
      CMASIFactory(const CMASIFactory & that);

      // Assignment Operator
      CMASIFactory & operator=(const CMASIFactory & that);
   };
