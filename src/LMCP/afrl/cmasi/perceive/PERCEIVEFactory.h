...
#ifndef _PERCEIVE_FACTORY_H_
#define _PERCEIVE_FACTORY_H_
...
namespace perceive {
   ...
   protected:
      // Constructor
      PERCEIVEFactory(void);

      // Copy Constructor
      PERCEIVEFactory(const PERCEIVEFactory & that);

      // Assignment Operator
      PERCEIVEFactory & operator=(const PERCEIVEFactory & that);
   };
